...
require_once("include/t_delivery_feedback_view11_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "t_delivery_feedback_view1" );
