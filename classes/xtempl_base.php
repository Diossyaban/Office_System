...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("t_delivery_view_chart","xt_showchart",
			array(
				"chartName"=>"t_delivery_view",
				"table"=>"t_delivery_view",
				"ctype"=>"2DDoughnut"));
			$this->assign_function("c_out_mail_chart","xt_showchart",
			array(
				"chartName"=>"c_out_mail",
				"table"=>"c_out_mail",
				"ctype"=>"2DDoughnut"));
		}
