...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("m_client_profile" == $this->chrt_array['tables'][0])
			return true;
		if("m_producer" == $this->chrt_array['tables'][0])
			return true;
		if("m_login" == $this->chrt_array['tables'][0])
			return true;
		if("m_bank" == $this->chrt_array['tables'][0])
			return true;
		if("m_asuransi" == $this->chrt_array['tables'][0])
			return true;
		if("m_kabupaten" == $this->chrt_array['tables'][0])
			return true;
		if("t_letter" == $this->chrt_array['tables'][0])
			return true;
		if("t_letter_flow" == $this->chrt_array['tables'][0])
			return true;
		if("m_type" == $this->chrt_array['tables'][0])
			return true;
		if("m_mapping_letter" == $this->chrt_array['tables'][0])
			return true;
		if("Tsun_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("m_category" == $this->chrt_array['tables'][0])
			return true;
		if("Tsun_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("m_asuransi" == $this->chrt_array['tables'][0])
			return true;
		if("m_template" == $this->chrt_array['tables'][0])
			return true;
		if("m_language" == $this->chrt_array['tables'][0])
			return true;
		if("m_position_siganture" == $this->chrt_array['tables'][0])
			return true;
		if("m_mapping_letter_pic" == $this->chrt_array['tables'][0])
			return true;
		if("t_letter" == $this->chrt_array['tables'][0])
			return true;
		if("t_letter" == $this->chrt_array['tables'][0])
			return true;
		if("m_letter_pic" == $this->chrt_array['tables'][0])
			return true;
		if("m_status" == $this->chrt_array['tables'][0])
			return true;
		if("m_announcement" == $this->chrt_array['tables'][0])
			return true;
		if("m_announcement_view" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_details" == $this->chrt_array['tables'][0])
			return true;
		if("m_location_office" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_address" == $this->chrt_array['tables'][0])
			return true;
		if("m_provinsi" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_address" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_address" == $this->chrt_array['tables'][0])
		...
		if("t_delivery_address" == $this->chrt_array['tables'][0])
			return true;
		if("m_kecamatan" == $this->chrt_array['tables'][0])
			return true;
		if("m_kelurahan" == $this->chrt_array['tables'][0])
			return true;
		if("m_disposition_type" == $this->chrt_array['tables'][0])
			return true;
		if("m_disposition" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("Tsun_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("Tsun_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("m_login" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("m_mapping_disposition" == $this->chrt_array['tables'][0])
			return true;
		if("m_division" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery" == $this->chrt_array['tables'][0])
		...
		if("m_status" == $this->chrt_array['tables'][0])
			return true;
		if("mp_tmail" == $this->chrt_array['tables'][0])
			return true;
		if("m_domestic_type" == $this->chrt_array['tables'][0])
			return true;
		if("m_overseas_type" == $this->chrt_array['tables'][0])
			return true;
		if("m_countries" == $this->chrt_array['tables'][0])
			return true;
		if("m_countries" == $this->chrt_array['tables'][0])
			return true;
		if("m_countries" == $this->chrt_array['tables'][0])
		...
		if("t_delivery" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_expedition" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_internal" == $this->chrt_array['tables'][0])
			return true;
		if("Tsun_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("t_output_client_profile" == $this->chrt_array['tables'][0])
			return true;
		if("Tsun_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("m_disposition" == $this->chrt_array['tables'][0])
			return true;
		if("t_register" == $this->chrt_array['tables'][0])
			return true;
		if("t_register" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_feedback" == $this->chrt_array['tables'][0])
			return true;
		if("m_mypage" == $this->chrt_array['tables'][0])
			return true;
		if("t_register" == $this->chrt_array['tables'][0])
			return true;
		...
		if("t_delivery" == $this->chrt_array['tables'][0])
			return true;
		if("sp_disposition_flow" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_feedback" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_feedback" == $this->chrt_array['tables'][0])
			return true;
		if("m_courier" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_internal" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_expedition" == $this->chrt_array['tables'][0])
		...
		if("t_register" == $this->chrt_array['tables'][0])
			return true;
		if("t_register_mapping" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery" == $this->chrt_array['tables'][0])
			return true;
		if("get_images" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery_feedback" == $this->chrt_array['tables'][0])
			return true;
		if("m_disposition" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("t_invoice" == $this->chrt_array['tables'][0])
			return true;
		if("t_invoice_det" == $this->chrt_array['tables'][0])
			return true;
		if("m_customer" == $this->chrt_array['tables'][0])
			return true;
		if("m_currency" == $this->chrt_array['tables'][0])
			return true;
		if("m_supplier" == $this->chrt_array['tables'][0])
			return true;
		if("t_purchase" == $this->chrt_array['tables'][0])
			return true;
		if("t_purchase_det" == $this->chrt_array['tables'][0])
			return true;
		if("m_payment_term" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("t_ticket" == $this->chrt_array['tables'][0])
			return true;
		if("m_ticket_category" == $this->chrt_array['tables'][0])
			return true;
		if("m_ticket_subcategory" == $this->chrt_array['tables'][0])
			return true;
		if("m_user_guide" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("t_delivery" == $this->chrt_array['tables'][0])
		...
		if("t_meeting_book" == $this->chrt_array['tables'][0])
			return true;
		if("view_delivery_history" == $this->chrt_array['tables'][0])
			return true;
		if("m_disposition" == $this->chrt_array['tables'][0])
			return true;
		if("t_meeting_book" == $this->chrt_array['tables'][0])
		...
		if("t_meeting_book" == $this->chrt_array['tables'][0])
			return true;
		if("m_participant_type" == $this->chrt_array['tables'][0])
			return true;
		if("t_booking" == $this->chrt_array['tables'][0])
			return true;
		if("t_booking" == $this->chrt_array['tables'][0])
			return true;
		if("m_vehicle" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
