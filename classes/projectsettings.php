...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("m_login", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "m_client_profile" ] = array( "url" => "m_client_profile", "type" => 0 );
	$projectEntitiesReverse[ "m_client_profile" ] = "m_client_profile";
	$projectEntities[ "m_producer" ] = array( "url" => "m_producer", "type" => 0 );
	$projectEntitiesReverse[ "m_producer" ] = "m_producer";
	$projectEntities[ "m_login" ] = array( "url" => "m_login", "type" => 0 );
	$projectEntitiesReverse[ "m_login" ] = "m_login";
	$projectEntities[ "m_bank" ] = array( "url" => "m_bank", "type" => 0 );
	$projectEntitiesReverse[ "m_bank" ] = "m_bank";
	$projectEntities[ "m_asuransi" ] = array( "url" => "m_asuransi", "type" => 0 );
	$projectEntitiesReverse[ "m_asuransi" ] = "m_asuransi";
	$projectEntities[ "m_kabupaten" ] = array( "url" => "m_kabupaten", "type" => 0 );
	$projectEntitiesReverse[ "m_kabupaten" ] = "m_kabupaten";
	$projectEntities[ "t_letter" ] = array( "url" => "t_letter", "type" => 0 );
	$projectEntitiesReverse[ "t_letter" ] = "t_letter";
	$projectEntities[ "t_letter_flow" ] = array( "url" => "t_letter_flow", "type" => 0 );
	$projectEntitiesReverse[ "t_letter_flow" ] = "t_letter_flow";
	$projectEntities[ "m_type" ] = array( "url" => "m_type", "type" => 0 );
	$projectEntitiesReverse[ "m_type" ] = "m_type";
	$projectEntities[ "m_mapping_letter" ] = array( "url" => "m_mapping_letter", "type" => 0 );
	$projectEntitiesReverse[ "m_mapping_letter" ] = "m_mapping_letter";
	$projectEntities[ "Category" ] = array( "url" => "category", "type" => 1 );
	$projectEntitiesReverse[ "category" ] = "Category";
	$projectEntities[ "m_category" ] = array( "url" => "m_category", "type" => 0 );
	$projectEntitiesReverse[ "m_category" ] = "m_category";
	$projectEntities[ "Type" ] = array( "url" => "type", "type" => 1 );
	$projectEntitiesReverse[ "type" ] = "Type";
	$projectEntities[ "template" ] = array( "url" => "template", "type" => 1 );
	$projectEntitiesReverse[ "template" ] = "template";
	$projectEntities[ "m_template" ] = array( "url" => "m_template", "type" => 0 );
	$projectEntitiesReverse[ "m_template" ] = "m_template";
	$projectEntities[ "m_language" ] = array( "url" => "m_language", "type" => 0 );
	$projectEntitiesReverse[ "m_language" ] = "m_language";
	$projectEntities[ "m_position_siganture" ] = array( "url" => "m_position_siganture", "type" => 0 );
	$projectEntitiesReverse[ "m_position_siganture" ] = "m_position_siganture";
	$projectEntities[ "m_mapping_letter_pic" ] = array( "url" => "m_mapping_letter_pic", "type" => 0 );
	$projectEntitiesReverse[ "m_mapping_letter_pic" ] = "m_mapping_letter_pic";
	$projectEntities[ "Language" ] = array( "url" => "language", "type" => 1 );
	$projectEntitiesReverse[ "language" ] = "Language";
	$projectEntities[ "Siganture" ] = array( "url" => "siganture", "type" => 1 );
	$projectEntitiesReverse[ "siganture" ] = "Siganture";
	$projectEntities[ "m_letter_pic" ] = array( "url" => "m_letter_pic", "type" => 0 );
	$projectEntitiesReverse[ "m_letter_pic" ] = "m_letter_pic";
	...
	$projectEntities[ "m_announcement_view" ] = array( "url" => "m_announcement_view", "type" => 0 );
	$projectEntitiesReverse[ "m_announcement_view" ] = "m_announcement_view";
	$projectEntities[ "home" ] = array( "url" => "home", "type" => 4 );
	$projectEntitiesReverse[ "home" ] = "home";
	$projectEntities[ "t_delivery" ] = array( "url" => "t_delivery", "type" => 0 );
	$projectEntitiesReverse[ "t_delivery" ] = "t_delivery";
	$projectEntities[ "t_delivery_details" ] = array( "url" => "t_delivery_details", "type" => 0 );
	$projectEntitiesReverse[ "t_delivery_details" ] = "t_delivery_details";
	$projectEntities[ "m_location_office" ] = array( "url" => "m_location_office", "type" => 0 );
	$projectEntitiesReverse[ "m_location_office" ] = "m_location_office";
	$projectEntities[ "t_delivery_address" ] = array( "url" => "t_delivery_address", "type" => 0 );
	$projectEntitiesReverse[ "t_delivery_address" ] = "t_delivery_address";
	$projectEntities[ "m_provinsi" ] = array( "url" => "m_provinsi", "type" => 0 );
	$projectEntitiesReverse[ "m_provinsi" ] = "m_provinsi";
	$projectEntities[ "v_m_provinsi" ] = array( "url" => "v_m_provinsi", "type" => 1 );
	$projectEntitiesReverse[ "v_m_provinsi" ] = "v_m_provinsi";
	$projectEntities[ "v_m_kecamatan" ] = array( "url" => "v_m_kecamatan", "type" => 1 );
	$projectEntitiesReverse[ "v_m_kecamatan" ] = "v_m_kecamatan";
	$projectEntities[ "v_m_kabupaten" ] = array( "url" => "v_m_kabupaten", "type" => 1 );
	$projectEntitiesReverse[ "v_m_kabupaten" ] = "v_m_kabupaten";
	$projectEntities[ "m_kecamatan" ] = array( "url" => "m_kecamatan", "type" => 0 );
	$projectEntitiesReverse[ "m_kecamatan" ] = "m_kecamatan";
	$projectEntities[ "m_kelurahan" ] = array( "url" => "m_kelurahan", "type" => 0 );
	$projectEntitiesReverse[ "m_kelurahan" ] = "m_kelurahan";
	$projectEntities[ "m_disposition_type" ] = array( "url" => "m_disposition_type", "type" => 0 );
	$projectEntitiesReverse[ "m_disposition_type" ] = "m_disposition_type";
	$projectEntities[ "m_disposition_inmail" ] = array( "url" => "m_disposition_inmail", "type" => 1 );
	$projectEntitiesReverse[ "m_disposition_inmail" ] = "m_disposition_inmail";
	$projectEntities[ "mp_tmail" ] = array( "url" => "mp_tmail", "type" => 4 );
	$projectEntitiesReverse[ "mp_tmail" ] = "mp_tmail";
	...
	$projectEntities[ "View" ] = array( "url" => "view", "type" => 7 );
	$projectEntitiesReverse[ "view" ] = "View";
	$projectEntities[ "m_mapping_disposition" ] = array( "url" => "m_mapping_disposition", "type" => 0 );
	$projectEntitiesReverse[ "m_mapping_disposition" ] = "m_mapping_disposition";
	$projectEntities[ "m_division" ] = array( "url" => "m_division", "type" => 0 );
	$projectEntitiesReverse[ "m_division" ] = "m_division";
	$projectEntities[ "t_delivery_view" ] = array( "url" => "t_delivery_view", "type" => 3 );
	$projectEntitiesReverse[ "t_delivery_view" ] = "t_delivery_view";
	$projectEntities[ "t_delivery_type_user" ] = array( "url" => "t_delivery_type_user", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_type_user" ] = "t_delivery_type_user";
	$projectEntities[ "v_status" ] = array( "url" => "v_status", "type" => 1 );
	$projectEntitiesReverse[ "v_status" ] = "v_status";
	$projectEntities[ "mp_marketing" ] = array( "url" => "mp_marketing", "type" => 4 );
	$projectEntitiesReverse[ "mp_marketing" ] = "mp_marketing";
	$projectEntities[ "m_domestic_type" ] = array( "url" => "m_domestic_type", "type" => 0 );
	$projectEntitiesReverse[ "m_domestic_type" ] = "m_domestic_type";
	$projectEntities[ "m_overseas_type" ] = array( "url" => "m_overseas_type", "type" => 0 );
	$projectEntitiesReverse[ "m_overseas_type" ] = "m_overseas_type";
	$projectEntities[ "m_countries" ] = array( "url" => "m_countries", "type" => 0 );
	$projectEntitiesReverse[ "m_countries" ] = "m_countries";
	$projectEntities[ "v_countries" ] = array( "url" => "v_countries", "type" => 1 );
	$projectEntitiesReverse[ "v_countries" ] = "v_countries";
	$projectEntities[ "v_states" ] = array( "url" => "v_states", "type" => 1 );
	$projectEntitiesReverse[ "v_states" ] = "v_states";
	$projectEntities[ "partnership_view" ] = array( "url" => "partnership_view", "type" => 1 );
	$projectEntitiesReverse[ "partnership_view" ] = "partnership_view";
	$projectEntities[ "sp_disposition_flow" ] = array( "url" => "sp_disposition_flow", "type" => 6 );
	$projectEntitiesReverse[ "sp_disposition_flow" ] = "sp_disposition_flow";
	$projectEntities[ "t_delivery_x" ] = array( "url" => "t_delivery_x", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_x" ] = "t_delivery_x";
	$projectEntities[ "t_delivery_expedition" ] = array( "url" => "t_delivery_expedition", "type" => 0 );
	$projectEntitiesReverse[ "t_delivery_expedition" ] = "t_delivery_expedition";
	$projectEntities[ "t_delivery_internal" ] = array( "url" => "t_delivery_internal", "type" => 0 );
	$projectEntitiesReverse[ "t_delivery_internal" ] = "t_delivery_internal";
	$projectEntities[ "members" ] = array( "url" => "members", "type" => 1 );
	$projectEntitiesReverse[ "members" ] = "members";
	$projectEntities[ "t_output_client_profile" ] = array( "url" => "t_output_client_profile", "type" => 0 );
	$projectEntitiesReverse[ "t_output_client_profile" ] = "t_output_client_profile";
	$projectEntities[ "outmail_maps" ] = array( "url" => "outmail_maps", "type" => 1 );
	$projectEntitiesReverse[ "outmail_maps" ] = "outmail_maps";
	$projectEntities[ "m_disposition_profile" ] = array( "url" => "m_disposition_profile", "type" => 1 );
	$projectEntitiesReverse[ "m_disposition_profile" ] = "m_disposition_profile";
	$projectEntities[ "t_register" ] = array( "url" => "t_register", "type" => 0 );
	$projectEntitiesReverse[ "t_register" ] = "t_register";
	$projectEntities[ "t_in_mail" ] = array( "url" => "t_in_mail", "type" => 1 );
	$projectEntitiesReverse[ "t_in_mail" ] = "t_in_mail";
	$projectEntities[ "t_delivery_feedback" ] = array( "url" => "t_delivery_feedback", "type" => 0 );
	$projectEntitiesReverse[ "t_delivery_feedback" ] = "t_delivery_feedback";
	$projectEntities[ "mypage_tmail" ] = array( "url" => "mypage_tmail", "type" => 1 );
	$projectEntitiesReverse[ "mypage_tmail" ] = "mypage_tmail";
	$projectEntities[ "t_register_view" ] = array( "url" => "t_register_view", "type" => 1 );
	$projectEntitiesReverse[ "t_register_view" ] = "t_register_view";
	$projectEntities[ "tsun_noti" ] = array( "url" => "tsun_noti", "type" => 0 );
	$projectEntitiesReverse[ "tsun_noti" ] = "tsun_noti";
	$projectEntities[ "m_disposition_register" ] = array( "url" => "m_disposition_register", "type" => 1 );
	$projectEntitiesReverse[ "m_disposition_register" ] = "m_disposition_register";
	$projectEntities[ "v_status_register" ] = array( "url" => "v_status_register", "type" => 1 );
	$projectEntitiesReverse[ "v_status_register" ] = "v_status_register";
	$projectEntities[ "c_out_mail" ] = array( "url" => "c_out_mail", "type" => 3 );
	$projectEntitiesReverse[ "c_out_mail" ] = "c_out_mail";
	$projectEntities[ "sp_notif_t_mail" ] = array( "url" => "sp_notif_t_mail", "type" => 6 );
	$projectEntitiesReverse[ "sp_notif_t_mail" ] = "sp_notif_t_mail";
	$projectEntities[ "t_delivery_feedback_view" ] = array( "url" => "t_delivery_feedback_view1", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_feedback_view1" ] = "t_delivery_feedback_view";
	$projectEntities[ "t_delivery_feedback_view1" ] = array( "url" => "t_delivery_feedback_view11", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_feedback_view11" ] = "t_delivery_feedback_view1";
	$projectEntities[ "m_courier" ] = array( "url" => "m_courier", "type" => 0 );
	$projectEntitiesReverse[ "m_courier" ] = "m_courier";
	$projectEntities[ "t_delivery_internal_view" ] = array( "url" => "t_delivery_internal_view", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_internal_view" ] = "t_delivery_internal_view";
	$projectEntities[ "t_delivery_expedition_view" ] = array( "url" => "t_delivery_expedition_view", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_expedition_view" ] = "t_delivery_expedition_view";
	$projectEntities[ "v_location_registration" ] = array( "url" => "v_location_registration", "type" => 1 );
	$projectEntitiesReverse[ "v_location_registration" ] = "v_location_registration";
	$projectEntities[ "t_register_mapping" ] = array( "url" => "t_register_mapping", "type" => 0 );
	$projectEntitiesReverse[ "t_register_mapping" ] = "t_register_mapping";
	$projectEntities[ "report_outmail_list" ] = array( "url" => "report_outmail_list", "type" => 1 );
	$projectEntitiesReverse[ "report_outmail_list" ] = "report_outmail_list";
	$projectEntities[ "get_images" ] = array( "url" => "get_images", "type" => 0 );
	$projectEntitiesReverse[ "get_images" ] = "get_images";
	$projectEntities[ "t_delivery_feedback_view2" ] = array( "url" => "t_delivery_feedback_view2", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_feedback_view2" ] = "t_delivery_feedback_view2";
	$projectEntities[ "m_disposition_inmail_x" ] = array( "url" => "m_disposition_inmail_x", "type" => 1 );
	$projectEntitiesReverse[ "m_disposition_inmail_x" ] = "m_disposition_inmail_x";
	$projectEntities[ "mp_ga" ] = array( "url" => "mp_ga", "type" => 4 );
	$projectEntitiesReverse[ "mp_ga" ] = "mp_ga";
	$projectEntities[ "t_invoice" ] = array( "url" => "t_invoice", "type" => 0 );
	$projectEntitiesReverse[ "t_invoice" ] = "t_invoice";
	$projectEntities[ "t_invoice_det" ] = array( "url" => "t_invoice_det", "type" => 0 );
	$projectEntitiesReverse[ "t_invoice_det" ] = "t_invoice_det";
	$projectEntities[ "m_customer" ] = array( "url" => "m_customer", "type" => 0 );
	$projectEntitiesReverse[ "m_customer" ] = "m_customer";
	$projectEntities[ "m_currency" ] = array( "url" => "m_currency", "type" => 0 );
	$projectEntitiesReverse[ "m_currency" ] = "m_currency";
	$projectEntities[ "m_supplier" ] = array( "url" => "m_supplier", "type" => 0 );
	$projectEntitiesReverse[ "m_supplier" ] = "m_supplier";
	$projectEntities[ "t_purchase" ] = array( "url" => "t_purchase", "type" => 0 );
	$projectEntitiesReverse[ "t_purchase" ] = "t_purchase";
	$projectEntities[ "t_purchase_det" ] = array( "url" => "t_purchase_det", "type" => 0 );
	$projectEntitiesReverse[ "t_purchase_det" ] = "t_purchase_det";
	$projectEntities[ "m_payment_term" ] = array( "url" => "m_payment_term", "type" => 0 );
	$projectEntitiesReverse[ "m_payment_term" ] = "m_payment_term";
	$projectEntities[ "mp_intech" ] = array( "url" => "mp_intech", "type" => 4 );
	$projectEntitiesReverse[ "mp_intech" ] = "mp_intech";
	$projectEntities[ "mp_helpdesk" ] = array( "url" => "mp_helpdesk", "type" => 4 );
	$projectEntitiesReverse[ "mp_helpdesk" ] = "mp_helpdesk";
	$projectEntities[ "t_ticket" ] = array( "url" => "t_ticket", "type" => 0 );
	$projectEntitiesReverse[ "t_ticket" ] = "t_ticket";
	$projectEntities[ "m_ticket_category" ] = array( "url" => "m_ticket_category", "type" => 0 );
	$projectEntitiesReverse[ "m_ticket_category" ] = "m_ticket_category";
	$projectEntities[ "m_ticket_subcategory" ] = array( "url" => "m_ticket_subcategory", "type" => 0 );
	$projectEntitiesReverse[ "m_ticket_subcategory" ] = "m_ticket_subcategory";
	$projectEntities[ "m_user_guide" ] = array( "url" => "m_user_guide", "type" => 0 );
	$projectEntitiesReverse[ "m_user_guide" ] = "m_user_guide";
	$projectEntities[ "sp_get_disposition_status" ] = array( "url" => "sp_get_disposition_status", "type" => 6 );
	$projectEntitiesReverse[ "sp_get_disposition_status" ] = "sp_get_disposition_status";
	$projectEntities[ "t_delivery_label" ] = array( "url" => "t_delivery_label", "type" => 1 );
	$projectEntitiesReverse[ "t_delivery_label" ] = "t_delivery_label";
	$projectEntities[ "m_meeting_room" ] = array( "url" => "m_meeting_room", "type" => 0 );
	$projectEntitiesReverse[ "m_meeting_room" ] = "m_meeting_room";
	$projectEntities[ "t_booking" ] = array( "url" => "t_booking", "type" => 0 );
	$projectEntitiesReverse[ "t_booking" ] = "t_booking";
	$projectEntities[ "t_meeting_book" ] = array( "url" => "t_meeting_book", "type" => 0 );
	$projectEntitiesReverse[ "t_meeting_book" ] = "t_meeting_book";
	$projectEntities[ "report_delivery_history_view" ] = array( "url" => "report_delivery_history_view", "type" => 1 );
	$projectEntitiesReverse[ "report_delivery_history_view" ] = "report_delivery_history_view";
	$projectEntities[ "m_disposition" ] = array( "url" => "m_disposition", "type" => 0 );
	$projectEntitiesReverse[ "m_disposition" ] = "m_disposition";
	$projectEntities[ "t_meeting_book_inqury" ] = array( "url" => "t_meeting_book_inqury", "type" => 1 );
	$projectEntitiesReverse[ "t_meeting_book_inqury" ] = "t_meeting_book_inqury";
	$projectEntities[ "t_meeting_book_approval" ] = array( "url" => "t_meeting_book_approval", "type" => 1 );
	$projectEntitiesReverse[ "t_meeting_book_approval" ] = "t_meeting_book_approval";
	$projectEntities[ "m_participant_type" ] = array( "url" => "m_participant_type", "type" => 0 );
	$projectEntitiesReverse[ "m_participant_type" ] = "m_participant_type";
	$projectEntities[ "t_booking_inquiry" ] = array( "url" => "t_booking_inquiry", "type" => 1 );
	$projectEntitiesReverse[ "t_booking_inquiry" ] = "t_booking_inquiry";
	$projectEntities[ "t_booking_approval" ] = array( "url" => "t_booking_approval", "type" => 1 );
	$projectEntitiesReverse[ "t_booking_approval" ] = "t_booking_approval";
	$projectEntities[ "m_vehicle" ] = array( "url" => "m_vehicle", "type" => 0 );
