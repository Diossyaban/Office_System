...
require_once("include/sp_get_disposition_status_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_get_disposition_status" );
