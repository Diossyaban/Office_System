...
require_once("include/m_disposition_profile_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "m_disposition_profile" );
