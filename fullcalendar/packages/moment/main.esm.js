...
import*as momentNs from'moment';import{createPlugin,Calendar}from'@fullcalendar/core';var moment=momentNs;function toMoment(date,calendar){if(!(calendar instanceof Calendar)){throw new Error('must supply a Calendar instance');}
...
var main=createPlugin({cmdFormatter:formatWithCmdStr});function createMomentFormatFunc(mom){return function(cmdStr){return cmdStr?mom.format(cmdStr):'';};}
...
export default main;export{toDuration,toMoment};