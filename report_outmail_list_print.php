...
require_once("include/report_outmail_list_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "report_outmail_list" );
