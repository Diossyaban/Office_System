...
require_once("include/m_disposition_register_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "m_disposition_register" );
