...
require_once("include/v_location_registration_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "v_location_registration" );
