...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "u736239518tsundbat154412412";
		$data["connName"] = "u736239518_tsundb at 154.41.24";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;154.41.241.2;u736239518_tsun;EX!hmdN1Ol];;u736239518_tsundb;;1"; //currently unused

		$this->_connectionsIdByName["u736239518_tsundb at 154.41.24"] = "u736239518tsundbat154412412";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "u736239518_tsun";
		$data["ODBCPWD"] = "EX!hmdN1Ol]";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "u736239518_tsun";
		$data["connInfo"][2] = "EX!hmdN1Ol]";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "u736239518_tsundb";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=154.41.241.2;Uid=u736239518_tsun;Pwd=EX!hmdN1Ol];Database=u736239518_tsundb;OPTION=3";
		// encription set
		...
		$connectionsData["u736239518tsundbat154412412"] = $data;
