...
require_once("include/t_delivery_internal_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "t_delivery_internal" );
