...
require_once("include/t_meeting_book_inqury_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "t_meeting_book_inqury" );
