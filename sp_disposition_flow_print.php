...
require_once("include/sp_disposition_flow_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_disposition_flow" );
