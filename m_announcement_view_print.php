...
require_once("include/m_announcement_view_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "m_announcement_view" );
